      ...
      <nav className="bg-white border-b-2 border-gray-200 px-2 sm:px-4 py-2 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
            <img src={Logo} className="mr-2 h-6 sm:h-9" alt="CineInfo Logo" />
            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">CineInfo</span>
          </Link>
          ...
          <div className={`${hidden ? "hidden" : ""} justify-between items-center w-full md:flex md:w-auto md:order-1`} id="navbar-search">
            ...
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <NavLink to="/movies/popular" className={({ isActive }) => {
                  if (isActive) {
                    updateTitle("Popular");
                    return activeClass;
                  } else {
              ...
              <li>
                <NavLink to="/movies/top" className={({ isActive }) => {
                  if (isActive) {
                    updateTitle("Top Rated");
                    return activeClass;
                  } else {
                    return inActiveClass;
                  }
              ...
              <li>
                <NavLink to="/movies/upcoming" className={({ isActive }) => {
                  if (isActive) {
                    updateTitle("Upcoming");
                    return activeClass;
                  } else {
                    return inActiveClass;
                  }
